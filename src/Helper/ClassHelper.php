...
class ClassHelper
{
    ...
    public function getResponseClassName(string $operationId, int $statusCode): string
    {
        return $this->stringHelper->convertToClassName("{$operationId}Response{$statusCode}");
    }
